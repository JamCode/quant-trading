...
VALUES
  ('fund_holdings_sync', '基金季报持仓', 'cron', '', 1, 40),
  ('stock_ths_industry_sync', '股票行业映射', 'cron', '', 1, 41),
  ('fund_industry_exposure_sync', '基金行业暴露', 'cron', '', 1, 42),
  ('fund_metrics_sync', '基金收益指标', 'cron', '', 1, 43)
